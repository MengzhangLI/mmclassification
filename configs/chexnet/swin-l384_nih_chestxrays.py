_base_ = [
    '../_base_/models/swin_transformer/large_384_train.py',
    '../_base_/datasets/nih_chestxrays_bs16_new.py',
...
checkpoint = './pretrain/swin_large_patch4_window12_384_22kto1k-0a40944b.pth'
model = dict(
